...
export default function TagsPage(): JSX.Element {
    ...
    if (showFullPageLoader) {
        return (
            <AppShell title="Tags" email={email}>
            ...
            <div className="flex flex-col gap-4 px-4 py-4">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Assign types to organize tags on this device.
                            Rename or remove tags across your library.
                        </CardDescription>
                    </CardHeader>
                        ...
                        {userTags.length === 0 ? (
                            <Empty className="border-0 p-4">
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>
                                        Add tags from a photo in the gallery.
                                    </EmptyDescription>
                                </EmptyHeader>
                            </Empty>
                        ) : (
